...
import static com.shpp.p2p.cs.adobrovolskyi.assignment14.Assignment14Part2.archive;
import static com.shpp.p2p.cs.adobrovolskyi.assignment14.Assignment14Part3.unarchive;
...
public class Assignment14Part1 {
    ...
    public static void main(String[] args) {
        ...
        if (args[0].equals("-a")) {
            exception = archive(args[1], args[2]);
            if (exception == 0) {
            ...
            exception = unarchive(args[1], args[2]);
            if (exception == 0) {
